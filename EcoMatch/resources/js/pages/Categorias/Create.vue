    ...
    <div class="p-6 md:p-10 bg-background min-h-screen text-foreground">
        ...
        <div class="max-w-3xl mx-auto">
            <div class="flex justify-between items-center mb-8">
                <div>
                    <h1 class="text-3xl font-bold tracking-tight mb-2">Crear Nueva Categoría</h1>
                    <p class="text-muted-foreground">Define un nuevo grupo para clasificar los materiales de tu empresa.</p>
                </div>
            ...
            <Card class="bg-card border-border shadow-none overflow-hidden">
                <form @submit.prevent="submit">
                    <CardHeader class="border-b border-border">
                        ...
                        <CardDescription>Completa el formulario para agregar una nueva categoría.</CardDescription>
                    </CardHeader>

                    <CardContent class="p-6 space-y-6">
                        <div>
                            <Label for="nombre" class="text-muted-foreground mb-2 block">Nombre de la Categoría</Label>
                            <Input id="nombre" v-model="form.nombre" placeholder="Ej: Cartón" 
                                class="bg-background border-border text-foreground focus-visible:ring-primary"/>
                        </div>
                        <div>
                            <Label for="descripcion" class="text-muted-foreground mb-2 block">Descripción (Opcional)</Label>
                            <Input id="descripcion" v-model="form.descripcion" placeholder="Ej: Empaques de cartón reciclable"
                                class="bg-background border-border text-foreground focus-visible:ring-primary"/>
                        </div>
                    </CardContent>
